...
- `ResumoOperacao` — painel vivo sticky que consolida o que está sendo criado
  (linhas, somas, parâmetros, status) + o CTA da fase atual. Elemento assinatura
  das telas de originação.
